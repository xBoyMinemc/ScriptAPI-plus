...
export class Events {
    ...
    */
     ...
     */
     ...
     /**
      * This event fires when player use bed.
      */
...
/**
 * Manages callbacks that are connected to a BeforePlayerSleep event.
 */
 export class BeforePlayerSleepEventSignal {
    /**
     * @remarks
     * Adds a callback that will be called on when player use bed.
     * @param callback
     */
    subscribe(callback: (arg: BeforePlayerSleepEvent) => void): (arg: BeforePlayerSleepEvent) => void;
    /**
     * @remarks
     * Removes a callback from being called when player use bed.
     * @param callback
     * @throws This function can throw errors.
     */
...
/**
 * An event for player use bed(want sleep).
 * second.
 */
 export class BeforePlayerSleepEvent {
    /**
     * the player or entity use bed,because of want sleep
     */
